...
-- Database Migration 001: Initial Production-Ready Relational Schema
-- Engine: PostgreSQL (Neon Compatible)
-- Standards: Strict Normalized Relational Schema, Foreign Keys, Check Constraints,
--            Numeric Financial Types, Audit Logs, and Comprehensive Indexing.
-- ==============================================================================
...
CREATE TABLE IF NOT EXISTS customer_addresses (
    ...
    label VARCHAR(50) NOT NULL, -- e.g. Home, Work, Clinic
...
-- ------------------------------------------------------------------------------
-- 3. VENDORS & BRANCHES DOMAIN
-- ------------------------------------------------------------------------------

CREATE TABLE IF NOT EXISTS service_categories (
    id SERIAL PRIMARY KEY,
    code VARCHAR(50) UNIQUE NOT NULL, -- FOOD, GROCERY, PRODUCTS, HALL_BOOKING, DOCTOR_BOOKING, DELIVERY, OTHER
...
CREATE TABLE IF NOT EXISTS product_variants (
    ...
    name VARCHAR(100) NOT NULL, -- Small, Medium, Large, 500g, 1kg
...
-- ------------------------------------------------------------------------------
-- 8. BOOKINGS DOMAIN (Halls, Clinics, Events)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 9. PAYMENTS DOMAIN (Paymob-ready architecture)
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 10. NOTIFICATIONS & AUDIT LOGGING DOMAINS
-- ------------------------------------------------------------------------------
...
-- ------------------------------------------------------------------------------
-- 11. STRATEGIC PERFORMANCE INDEXES
-- ------------------------------------------------------------------------------
